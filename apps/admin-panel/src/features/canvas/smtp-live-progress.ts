...
export const SMTP_BUILD_STEPS: SmtpBuildStepDefinition[] = [
  ...
  { step: 6, skill: "bind_webdock_main_domain", label: "Vinculando dominio + PTR", eta: "~10s", nodeId: "vps_lxc_plan" },
  { step: 7, skill: "upsert_dns_route53", label: "Configurando DNS (A/MX)", eta: "~30-60s", nodeId: "dns_identity" },
  { step: 8, skill: "wait_for_dns_propagation", label: "Esperando propagación A", eta: "~30-90s", nodeId: "dns_identity" },
