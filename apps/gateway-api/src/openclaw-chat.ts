  ...
  if (/\b(infraestructura|infrastructure|inventario|inventory|proveedor|proveedores|provider|providers|webdock|aws|sender\s*pool|panel)\b/.test(normalized)) {
    return {
      ...
      content: [
        ...
        "- Webdock × 5 cuentas (compute primario + cuentas secundarias conectadas).",
        "- Contabo (2do proveedor VPS/SMTP; cuenta propia integrada, 0 servidores vivos hasta el primer E2E).",
